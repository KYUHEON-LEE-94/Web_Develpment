...
<main class="form-signin w-80 m- 200px auto">
  <form method="post" action="/user/login.do">
    ...
    <div class="form-floating">
      <input type="password" class="form-control" id="floatingPassword" placeholder="비밀번호" name="passwd">
      <label for="floatingPassword">Password</label>
    </div>

    <div class="checkbox mb-3">
      <label>
        <input type="checkbox" value="remember-me" name="saveid"> 아이디 저장
      </label>
    </div>
