		...
		<form>
			...
			<div class="form-floating">
				<input type="password" class="form-control" id="passwd"
					placeholder="비밀번호"> <label for="passwd">비밀번호</label>
			</div>

			<div class="checkbox mb-3">
				<label> <input type="checkbox" value="remember-id">
					아이디 저장
				</label>
			</div>

			<div class="form-floating">
				<button class="w-20 btn btn-md btn-primary" type="submit">로그인</button>
				<a href="#" class="w-20 btn btn-md btn-warning">회원가입</a>
			</div>
